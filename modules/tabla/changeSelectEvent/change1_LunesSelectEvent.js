...
// Definimos la función changeLunesSelectEvent que se ejecuta cuando se cambia el valor de un elemento select
function changeLunesSelectEvent(tabla, database, collection) {
