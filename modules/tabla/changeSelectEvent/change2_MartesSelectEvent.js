...
export { changeMartesSelectEvent };
...
// Definimos la función changeMartesSelectEvent que se ejecuta cuando se cambia el valor de un elemento select
function changeMartesSelectEvent(tabla, database, collection) {
