...
export { changeJuevesSelectEvent };
...
// Definimos la función changeJuevesSelectEvent que se ejecuta cuando se cambia el valor de un elemento select
function changeJuevesSelectEvent(tabla, database, collection) {
