...
export { changeSabadoSelectEvent };
...
// Definimos la función changeSabadoSelectEvent que se ejecuta cuando se cambia el valor de un elemento select
function changeSabadoSelectEvent(tabla, database, collection) {
